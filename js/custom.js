...
// let section = document.querySelector("#trend")
// let moveobject = document.querySelector(".trendimg-image")

// section.addEventListener("mousemove",function(event){
//   console.log("ami",event.clientX)
//   console.log("tmi",event.clientY)
  

//   // moveobject.style.top = `${event.clientY/50}px`
//   moveobject.style.left = `-${event.clientX/20}px`
// })
...
// let main = document.querySelectorAll(".main-team-area")
